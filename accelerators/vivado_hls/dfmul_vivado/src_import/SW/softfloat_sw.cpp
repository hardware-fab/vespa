...
static float64
float64_mul_int (float64 a, float64 b)
{
...
void float64_mul_sw (float64 operands[2], float64 result[1])
{
	result[0] = float64_mul_int(operands[0], operands[1]);
  //printf("A=%016llx, B=%016llx    -    Res=%016llx\n", operands[0], operands[1], result[0]);
}
