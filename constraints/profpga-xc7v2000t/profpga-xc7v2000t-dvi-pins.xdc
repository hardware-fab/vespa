...
set_property PACKAGE_PIN AW43 [get_ports tft_bsel]

# {eb_ba2_2_DVI_OUT_DSEL_SDA}
set_property PACKAGE_PIN AJ36 [get_ports tft_dsel]

# {eb_ba2_2_DVI_OUT_ISEL_NRST}
set_property PACKAGE_PIN AY41 [get_ports tft_isel]


# {eb_ba2_2_DVI_OUT_IDCLK_N}
set_property PACKAGE_PIN AT40 [get_ports tft_clk_n]

# {eb_ba2_2_DVI_OUT_IDCLK_P}
set_property PACKAGE_PIN AT39 [get_ports tft_clk_p]

# {eb_ba1a1_1_DVI_OUT_HSYNC}
set_property PACKAGE_PIN AW41 [get_ports tft_hsync]

# {eb_ba1a1_1_DVI_OUT_VSYNC}
set_property PACKAGE_PIN AW40 [get_ports tft_vsync]

# Hot plug detect active low (nhpd). redirecting to TFP410 (htplg)
# {eb_ba2_2_DVI_OUT_NHPD}
set_property PACKAGE_PIN AH38 [get_ports tft_nhpd]
# {eb_ba2_2_DVI_OUT_EDGE}
set_property PACKAGE_PIN AY43 [get_ports tft_edge]


# Tie to constant
# {eb_ba2_2_DVI_OUT_A3_DK3}
set_property PACKAGE_PIN AW44 [get_ports tft_a3_dk3]

# {eb_ba2_2_DVI_OUT_CTL1_A1_DK1}
set_property PACKAGE_PIN BB42 [get_ports tft_ctl1_a1_dk1]

# {eb_ba2_2_DVI_OUT_CTL2_A2_DK2}
set_property PACKAGE_PIN BA42 [get_ports tft_ctl2_a2_dk2]

# {eb_ba2_2_DVI_OUT_DKEN}
set_property PACKAGE_PIN BB44 [get_ports tft_dken]

# {eb_ba2_2_DVI_OUT_NPD}
set_property PACKAGE_PIN AY42 [get_ports tft_npd]
