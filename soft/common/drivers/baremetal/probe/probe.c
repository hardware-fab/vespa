...
static uintptr_t uncached_area_ptr = 0x80080000;
static uintptr_t uncached_area_ptr_bank1 = 0x80000000 + MEM_SIZE_MAIN;
static uintptr_t uncached_area_ptr_bank2 = 0x80000000 + MEM_SIZE_MAIN + MEM_SIZE_ADD;
static uintptr_t uncached_area_ptr_bank3 = 0x80000000 + MEM_SIZE_MAIN + MEM_SIZE_ADD*2;
#endif
