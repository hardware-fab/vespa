...
# custom constraints
XDC  += $(DESIGN_PATH)/socgen/esp/gm_dfs_constraints.xdc
endif
endif
...
# adding two lines to print out the hierarchical utilization report
	@echo "open_run impl_1" >> $@
	@echo "report_utilization -file $(DESIGN_PATH)/vivado/esp-profpga-xc7v2000t.runs/impl_1/hierarchical_utilization.rpt -hierarchical" >> $@
